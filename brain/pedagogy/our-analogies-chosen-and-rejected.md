...
- **Browser rendering = a projector showing a slide.** The slide comes from elsewhere; the picture is produced locally.
- **A request = a posted letter.** Post it, wait for the reply to travel back — the round trip.
